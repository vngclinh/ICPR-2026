...
checkpoint = os.path.join(PROJECT, "results", "restran_sr_v6_best.pth")
log_path = os.path.join(PROJECT, "results", "sr_v6_cpu_eval_watcher.log")
output_csv = os.path.join(PROJECT, "results", "test_predictions_restran_sr_v6_cpu.csv")
